...
INSERT INTO `decor_details` (`prod_id`, `decor_id`, `quantity`) VALUES (1, 2, 3);
INSERT INTO `decor_details` (`prod_id`, `decor_id`, `quantity`) VALUES (1, 4, 5);
...
INSERT INTO `order_prod_details` ( `order_id`, `prod_id`, `prod_quantity`)
VALUES ( 1, 3, 2);
...
CREATE VIEW `order_prod_detail_view` AS
    SELECT
        `o`.*,
        `p`.`name`,
        `p`.`image`,
