const QUERY_ORDERS = {
    ...
    CREATE_ORDER: "INSERT INTO orders (cus_id, delivery_status, total_price, total_unit) VALUES (?, ?, ?, ?)",
    UPDATE_ORDER: "UPDATE orders SET cus_id = ?, delivery_status = ?, total_price = ?, total_unit = ? WHERE order_id = ?",
