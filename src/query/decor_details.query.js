const QUERY_DECOR_DETAILS = {
    ...
    CREATE_DECOR_DETAIL: "INSERT INTO `decor_details` (`decor`, `unit_price`, `quantity`, `total_price`) VALUES (?, ?, ?, ?)",
    UPDATE_DECOR_DETAIL: "UPDATE `decor_details` SET `decor` = ?, `unit_price` = ?, `quantity` = ?, `total_price` = ? WHERE `decor_detail_id` = ?",
